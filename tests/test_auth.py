...
class TestFlaskApi(unittest.TestCase):
    ...
    def test_register_new_user(self):
        response = self.client.post('/api/v1/auth/register', data=json.dumps(register_user), content_type='application/json')
    ...
    def test_register_new_user_invalid_email(self):
        response = self.client.post('/api/v1/auth/register', data= json.dumps(user_invalid_email), content_type='application/json')
        data = json.loads(response.data)
        self.assertEqual(response.status_code, 401)
        self.assertIn('Please enter a valid Email.', data['message'])

    def test_register_new_user_no_name_given(self):
        response = self.client.post('/api/v1/auth/register', data=json.dumps(user_no_name),
    ...
    def test_register_existing_user(self):
        self.client.post('/api/v1/auth/register', data=json.dumps(register_user2),
                       content_type='application/json')
        response1 = self.client.post('/api/v1/auth/register', data=json.dumps(register_user2),
                                 content_type='application/json')
    ...
    def test_login_user_password_not_given(self):
        response = self.client.post('/api/v1/auth/login', data=json.dumps(user_login_details_no_password),
                                 content_type='application/json')
        self.assertEqual(response.status_code, 401)
        data = json.loads(response.data)
    ...
    def test_login_user_wrong_password_given(self):
        self.client.post('/api/v1/auth/register', data=json.dumps(register_user3),
                         content_type='application/json')
        response = self.client.post('/api/v1/auth/login', data=json.dumps(user_login_details_wrong_password),
                                 content_type='application/json')
    ...
    def test_login_user_invalid_email_given(self):
        response = self.client.post('/api/v1/auth/login', data=json.dumps(user_login_details_invalid_email),
                                 content_type='application/json')
        self.assertEqual(response.status_code, 401)

    def test_login_user_new_email_given(self):
        response = self.client.post('/api/v1/auth/login', data=json.dumps(user_login_details_new_email),
                                 content_type='application/json')
        self.assertEqual(response.status_code, 400)
